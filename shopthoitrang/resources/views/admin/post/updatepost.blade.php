                            ...
                            <div class="form-group mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-9"><input type="text" id="content_post" class="form-control"
                                            name="content_post" value="{{ $post->content_post }}"
                                            required autofocus></div>
